#Jackson Frizzell, KP San Nicolas, Hannah Van Cise
...
def simulation(sim_length, reg_lane_num):
    ...
    headers2 = ["Reg", "Tot Cust", "tot items", "tot idle",
                "avg wait"]
    reg_list = ["express"]
...
def main():
    ...
    for i in range(sim_runs):
        print()
        simulation(sim_seconds, 5) # num of regular lanes

main()

#No, a fifth regular line does not need to be added, as the average wait is usually 30 seconds.
#A sixth regular line does reduce the wait.
